"""
Django settings for darth-twitter project.
...
ROOT_URLCONF = 'darth-twitter.urls'
...
WSGI_APPLICATION = 'darth-twitter.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.getenv('DJANGO_LOG_FILE', './darth-twitter.log'),
            'formatter': 'simple'
        },
    },
    'loggers': {
